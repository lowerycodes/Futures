...
# === CONFIG ===
BASE_URL = "https://webapp-proxy.aws.barchart.com/v1/proxies/timeseries/historical/queryeod.ashx?symbol={symbol}{expiry}&data=daily&maxrecords=90&volume=total&order=asc&dividends=false&backadjust=false&daystoexpiration=1&contractroll=expiration&username=demochartsnew_rt&password=demochartsnew"  
